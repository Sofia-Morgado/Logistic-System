 ...
 * Descrição: Programa de um sistema de logística que permite gerir stocks de produtos e encomendas
*/
...
void adiciona_produto_encomenda(){
    ...
    if (ide >= te){
        ...
        /*Verificamos se o produto já se encontra na encomenda*/
        for (i=0; i<max; i++){
        ...
        /*adicionar novo produto à encomenda*/
...
void altera_preco(){
    ...
    if (idp >= tp){
        ...
        /* vamos alterar o preco também nas encomendas em que o produto aparece*/
...
void maximo_produto(){
    ...
    if (idp >= tp){
        ...
        /* se o max for diferente de 0, então o produto foi encontrado pelo menos numa encomenda*/
        if (max != 0){
